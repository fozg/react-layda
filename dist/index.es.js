      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('img', { src: ToggleIcon, width: '18', className: 'HeaderLeft__sidebarToggle__icon' })
          ),
          headerLeft
        ),
        headerCenter,
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          header && React.createElement(Header, _extends$b({}, header, { styleHeader: styleHeader, onToggle: this._onToggle })),
          React.createElement(
            'div',
                ...
                return React.createElement(Route, {
                  ...
                  render: function render(props) {
                    return React.createElement(
                      ...
                      board.sidebar && React.createElement(Route, {
                        path: board.path + '/:' + (board.sidebar.sidebarParam || 'id'),
                        render: function render(_ref2) {
                          var match = _ref2.match;
                          return React.createElement(SideBar, _extends$b({}, board.sidebar, {
                            match: match
                          }));
                        }
                      })
...
var LinkToSidebar = (function (_ref) {
  var children = _ref.children,
      boardPath = _ref.boardPath,
      sidebarLink = _ref.sidebarLink;
  return React.createElement(
    Link,
    {
      to: boardPath + '/' + sidebarLink.replace('/', '')
    },
    children
  );
});
...
var ExampleComponent = function (_Component) {
  ...
  createClass(ExampleComponent, [{
    key: 'render',
    value: function render() {
      return React.createElement(Dashboard, this.props);
    }
  }]);
